  ...
  return (
    <Section id="how-to-use">
        <div className='container'>
            <Heading title="Generative AI made for creators." text="Brainwave unlocks the potential of AI-powered
            applications."/>

            <div className='relative'>      
               {/*  service 1 */}
                <div className='relative z-1 flex items-center h-[39rem] mb-5 border border-n-1/10 
                rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                    ...
                    xl:w-auto'>
                        <img src={service1} alt="Smartet AI" 
                        className='w-full h-full object-cover md:object-right' width={800} height={730}/>
                    </div>
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    ...
                    <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
                        <div className='absolute inset-0'>
                            <img src={service2} alt="robot" 
                            className='h-full w-full object-cover' width={630} height={750}/>
                        </div>  
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                        <div className='py-12 px-4 xl:px-8'>
                            ...
                            <ul className='flex items-center justify-between'>
                                {brainwaveServicesIcons.map((item,index) => (
                                    <li key={index} className={`rounded-2xl flex items-center justify-center ${index === 2  
                        ...
                        <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>
                            <img src={service3} alt="robot 2" 
                            className='h-full w-full object-cover' width={520} height={400}/>
                            <VideoChatMessage/>
                            <VideoBar/>
                        </div>
