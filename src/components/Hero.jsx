        ...
        <div className='container relative' ref={parallaxRef}>
            ...
            lg:mb:[6rem]'>
                <h1 className='h1 mb-6'>
                    ...
                    src={curve} alt="curve" className='absolute top-full left-0 w-full xl:-mt-2' width={624}
                    height={28}/></span>
                </h1>
                ...
                <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                    <div className='relative bg-n-8 rounded-[1rem]'>
                        ...
                        md:aspect-[688/490] lg:aspect-[1024/490]'>
                            <img src={robot} alt="AI" className='w-full scale-[1.7] translate-y-[8%] md:scale-[1]
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                ...
                                bottom-[11rem] w-[18rem] xl:flex" title="Code generation"/>
                            </ScrollParallax>
                        </div>
                    </div>
